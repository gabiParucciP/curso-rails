module V1
  class ContactsController < ApplicationController
    ...
    def index
      ...
      render json: @contacts # , methods: :bithdate_br # , include: :kind # vem do modele faz o merge com o retorno
    ...
    def create
      ...
      if @contact.save
        ...
        render json: ErrorSerializer.serialize(@contact_errors) # @contact.errors, status: :unprocessable_entity
      end
    end
